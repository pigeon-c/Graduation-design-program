...
#define SECYR			(SECDAY * 365)     //一年有多少秒
#define	leapyear(year)		((year) % 4 == 0)  //判断是不是润年
#define	days_in_year(a) 	(leapyear(a) ? 366 : 365) //润年多一天
#define	days_in_month(a) 	(month_days[(a) - 1])    //判断一个月有几天

static int month_days[12] = {	31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 };//月份天数数组
